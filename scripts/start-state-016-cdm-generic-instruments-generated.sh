...
export GRAFANA_PORT
COMPOSE_DIR="${GENERATED_ROOT}/code/target-generated/cdm-generic-instruments"
...
bash "${REPO_ROOT}/scripts/start-grafana-traderx-dashboards.sh" \
  ...
  "TraderX" \
  "traderx-obs-016-cdm-generic-instruments" || true

echo "[done] state 016 CDM generic instruments runtime started"
